...
class _DailyRevenueChartState extends State<DailyRevenueChart> {
                ...
                child: Stack(
                  ...
                  children: [
                              ...
                              children: [
                                FittedBox(
                                  ...
                                  child: Text(
                                    ...
                                    style: const TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: Color(0xFF1F2937)),
                                  ),
                                ),
                    ...
                    if (_selectedIndex != null) ...[
                      _buildTooltip(columnWidth, constraints.maxWidth),
                    ]
                  ],
                ),
              ),
  ...
  Widget _buildTooltip(double columnWidth, double maxWidth) {
...
class _DailyOrdersChartState extends State<DailyOrdersChart> {
              ...
              SizedBox(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    if (_selectedIndex != null) ...[
                      _buildTooltip(widthStep, constraints.maxWidth),
                    ]
                  ],
                ),
              ),
  ...
  Widget _buildTooltip(double widthStep, double maxWidth) {
    int index = _selectedIndex!;
    var item = widget.data[index];
...
class LineChartPainter extends CustomPainter {
  ...
  LineChartPainter({required this.points, required this.days, this.selectedIndex});
      ...
      if (selectedIndex != i) {
        final textPainter = TextPainter(
          text: TextSpan(
            ...
            style: const TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: Color(0xFF30475E)),
          ),
...
class _TopProductsChartState extends State<TopProductsChart> {
            ...
            children: [
              ...
              Stack(
                ...
                children: [
                    ...
                    children: widget.data.asMap().entries.map((entry) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isSelected ? Colors.grey.withAlpha(20) : Colors.transparent,
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    AnimatedContainer(
                                      ...
                                      height: 10,
                                      decoration: BoxDecoration(
                                        color: isSelected ? const Color(0xFFF05454) : const Color(0xFF30475E),
                                        borderRadius: BorderRadius.circular(5),
                                      ),
                                    ),
                                  ],
                  ...
                  if (_selectedIndex != null) ...[
                    _buildRowTooltip(constraints.maxWidth),
                  ]
                ],
              ),
            ],
  ...
  Widget _buildRowTooltip(double maxWidth) {
    int index = _selectedIndex!;
    var item = widget.data[index];
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: Color(0xFF1F2937)),
                            ),
                          ],
                        ),
                      )
